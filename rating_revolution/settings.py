"""
Django settings for rating_revolution project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'hkf_&kfu!a^7m*b7pww!@msoci8jxu#=w(1=3#h2bs=z1qta_-')
...
MIDDLEWARE = [
    ...
    'rating_revolution.swagger.SwaggerSchemaMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
]

ROOT_URLCONF = 'rating_revolution.urls.urls'
...
WSGI_APPLICATION = 'rating_revolution.wsgi.application'
